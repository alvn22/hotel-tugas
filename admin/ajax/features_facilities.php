        ...
        while($row = mysqli_fetch_assoc($res)){
            echo <<<data
                <tr>
                    ...
                    <td>$row[name]</td>
                    <td>
                        <button type="button" onclick="rem_feature($row[id])" class="btn btn-danger shadow-none">
        ...
        while($row = mysqli_fetch_assoc($res)){
            echo <<<data
                <tr class="align-middle">
                    ...
                    <td>
                        <button type="button" onclick="rem_facility($row[id])" class="btn btn-danger shadow-none">
                            <i class="bi bi-trash"></i> Delete
                        </button>
                    </td>
                </tr>
