...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold judul text-center">ABOUT</h2>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4">
                ...
                <p>
                    ...
                    Odio enim cumque similique ipsam aperiam est doloremque!
                </p>
            </div>
            <div class="col-lg-6 col-md-5 mb-4">
    ...
    <h3 class="my-5 fw-bold judul text-center">MANAGEMENT TEAM</h3>
